function [x, w] = hermite_rule(n, a, b, scale)
...
%
%  Modified by Eike Petersen, March 2020: No file is written. Instead,
%  quadrature points and weights are returned. Also, no interactive input
%  handling, and no verbose console output. Removed a few functions that 
%  became obsolete due to these changes. No other changes apart from these.
%
%  Modified:
%
%    06 February 2014
